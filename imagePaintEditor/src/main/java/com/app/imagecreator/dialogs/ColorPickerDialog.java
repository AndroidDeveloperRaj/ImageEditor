...
import com.app.imagecreator.utility.ColorPicker;

public class ColorPickerDialog extends AlertDialog {

    private ColorPicker colorPickerView;
    private final OnColorSelectedListener onColorSelectedListener;
    private final OnColorDeSelectedListener onColorDeSelectedListener;

    public ColorPickerDialog(Context context, int initialColor, OnColorSelectedListener onColorSelectedListener, OnColorDeSelectedListener onColorDeSelectedListener) {
        super(context);

        this.onColorSelectedListener = onColorSelectedListener;

        this.onColorDeSelectedListener = onColorDeSelectedListener;
        ...
        public void onClick(DialogInterface dialog, int which) {
            switch (which) {
                ...
                case BUTTON_NEGATIVE:
                    onColorDeSelectedListener.onDeColorSelected();
                    dialog.dismiss();
                    break;
            }
        }
    ...
    public interface OnColorDeSelectedListener {
